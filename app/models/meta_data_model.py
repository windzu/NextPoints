...
from app.models.calibration_model import CalibrationMetadata, SensorType
...
class ProjectMetadataResponse(BaseModel):
    ...
    def validate_frames_and_calibration(self):
        ...
        calib_lidar_keys = {name for name, calib in self.calibration.items()
                            if calib.sensor_type == SensorType.LIDAR}
        calib_camera_keys = {name for name, calib in self.calibration.items()
